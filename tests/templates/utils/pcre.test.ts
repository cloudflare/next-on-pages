...
const matchPCRETestCases: TestCase[] = [
	{
...
const applyPCREMatchesTestCases: TestCase[] = [
	{
...
describe('matchPCRE', () => {
	matchPCRETestCases.forEach(testCase => {
		test(testCase.name, () => {
...
describe('applyPCREMatches', () => {
	applyPCREMatchesTestCases.forEach(testCase => {
		test(testCase.name, () => {
