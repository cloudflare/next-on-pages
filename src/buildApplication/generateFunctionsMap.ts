 ...
 * in the ./static/media directory generated by Next.js and moves that one in the static
 * output directory instead
 *
 * (Note: this is hopefully just a temporary solution, hopefully Next.js will allow to opt
 *        out from the favicon function generation or allow it to use the edge runtime)
 */
